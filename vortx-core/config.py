...
The backend loads environment variables from the single repo-root file:
hackathon/vortx/.env
"""
...
# The project env file should override stale shell or machine-level variables.
...
INTERSWITCH_API_BASE_SANDBOX = os.getenv(
    "INTERSWITCH_API_BASE_SANDBOX",
...
INTERSWITCH_API_BASE_PROD = os.getenv(
    "INTERSWITCH_API_BASE_PROD",
...
NANO_LOAN_OFFER_HOURS = int(os.getenv("NANO_LOAN_OFFER_HOURS", "48"))
NANO_LOAN_TERM_DEFAULT = int(os.getenv("NANO_LOAN_TERM_DEFAULT", "7"))
HIGH_VALUE_THRESHOLD = float(os.getenv("HIGH_VALUE_THRESHOLD", "100000"))  # NGN 100k
DEADMAN_SWITCH_HOURS = int(os.getenv("DEADMAN_SWITCH_HOURS", "24"))
...
# ENCRYPTION
# ========================================
ENCRYPTION_KEY = os.getenv("ENCRYPTION_KEY", "").strip().strip("\"'")
